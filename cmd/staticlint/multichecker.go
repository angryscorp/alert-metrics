...
func main() {
	...
	// 3rd party public checkers
	analyzers = append(analyzers, errcheck.Analyzer, ineffassign.Analyzer)

	// My analyzer
	analyzers = append(analyzers, exitCodeAnalyzer)
